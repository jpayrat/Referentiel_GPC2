<br>resultilot
<br>
<?php foreach($dataSelectAll['dataIlot'] as $data): ?>
    
    <h1> <?= $data['iloCodeIlot']; ?> - [<?= $data['iloCodeIlot']; ?>] <span style="float: right; margin-right: 15px;">utilisé : <?= $data['used'];?></span></h1>
    <hr />
    ...
    <div class="bloc_front_titre">Périmètre d\'intervention <span>:</span></div><div class="bloc_front_aff"><?= $data['listeSites'];?></div><br />
    </div>
    <div class="bloc_side">
